...
```bash
npm add @dl2/%NAME% [--dev]
# OR
yarn add @dl2/%NAME% [--dev]
```
...
For details about the `@dl2/%NAME%` API, see the [reference documentation].

## Developer documentation

For getting started as a `@dl2/%NAME%` developer, see the [developer documentation].
...
[issues section]: %REPOSITORY%/issues
[reference documentation]: ./docs/api
[security advisory team]: mailto:%SECURITY-ADVISORY%
